...
class HipotesisPeaton(models.Model):
    ...
    def __str__(self):
        return self.descripcion
# 1. Agrega esta nueva clase después de la clase HipotesisPeaton (aproximadamente línea 120)
class HipotesisPasajero(models.Model):
    """
    Modelo para almacenar las hipótesis relacionadas con el pasajero.
    """
    descripcion = models.CharField(max_length=255)
...
class Accidente(models.Model):
    ...
    # 2. Luego, dentro de la clase Accidente, añade estos campos nuevos 
# (aproximadamente después de la línea 450, en la sección de Hipótesis)

# Añadir estos campos nuevos después de hipotesis_peaton2
    hipotesis_pasajero1 = models.ForeignKey(HipotesisPasajero, on_delete=models.SET_NULL, blank=True, null=True, 
                                     related_name='accidentes_hipotesis_principal', verbose_name='Hipótesis Principal Pasajero')
    hipotesis_pasajero2 = models.ForeignKey(HipotesisPasajero, on_delete=models.SET_NULL, blank=True, null=True, 
                                     related_name='accidentes_hipotesis_secundaria', verbose_name='Hipótesis Secundaria Pasajero')
